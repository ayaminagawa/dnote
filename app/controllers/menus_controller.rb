class MenusController < ApplicationController
  ...
  private
    ...
    def menu_params
      params.require(:menu).permit(:name, :point, :category, :image, category_selects_attributes: [:id, :category_number2, :category_number3, :category_number4, :category_number5, :category_number6], menu_recipes_attributes: [:recipe_id])
    end
